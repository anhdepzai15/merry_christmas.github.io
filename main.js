let pic=document.getElementById('box');
let btn=document.getElementById('btn');
let santan=document.getElementById('santan');
let lbsantan=document.getElementById('lbWrapper');
let time =document.getElementById('container');

pic.addEventListener('click',function(){
    pic.style.display='none';
    santan.style.display='block';
    //time.style.display='inline-block';
    //lbsantan.style.display='block';
    
})
/*Lấy thời gian Giáng Sinh (mily giây)*/
var tetAmLich = new Date(2022, 11, 25, 0, 0, 0).getTime();
